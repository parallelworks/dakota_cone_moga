...
def createBasic(metrichash, dataReader, dataDisplay):
    ...
    dataDisplay.Opacity = bodyopacity
    try:
        print metrichash['bodycolor']
        r,g,b = [float(x) for x in metrichash['bodycolor'].split(",")]
        dataDisplay.ColorArrayName = [None, '']
        dataDisplay.SetRepresentationType('Surface')
        dataDisplay.DiffuseColor = [r/255.0, g/255.0, b/255.0]
    except:
        pass
